...
# Form implementation generated from reading ui file 'GUIEliminarLibro.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(314, 406)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(314, 0))
        MainWindow.setMaximumSize(QtCore.QSize(314, 477))
        ...
        self.lblAutor = QtWidgets.QLineEdit(self.centralwidget)
        self.lblAutor.setEnabled(False)
        self.lblAutor.setGeometry(QtCore.QRect(120, 170, 181, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 230, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(12)
        ...
        self.chxTapaDura.setEnabled(False)
        self.chxTapaDura.setGeometry(QtCore.QRect(10, 300, 91, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(10)
        ...
        self.lblPaginas.setEnabled(False)
        self.lblPaginas.setGeometry(QtCore.QRect(120, 200, 181, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.lblPrecio.setEnabled(False)
        self.lblPrecio.setGeometry(QtCore.QRect(120, 230, 181, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.btnEliminar.setGeometry(QtCore.QRect(230, 330, 75, 23))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Buscar libro"))
        ...
        self.label_7.setText(_translate("MainWindow", "Eliminar Libro"))
    ...
    def eliminar(self):
        servicioAutor.eliminar_autor(txtNombre.getText)
